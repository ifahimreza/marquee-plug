...
class MarqueePlug {
  constructor(container, options = {}) {
    ...
    this.container.className = 'mp-container';
    this.options = {
      autoFill: false,
      play: true,
      pauseOnHover: false,
    ...
    this.items = Array.from(this.container.querySelectorAll('div'));
   ...
   */
  wrapInitialItems() {
    const initialChildContainer = document.createElement('div');
    initialChildContainer.className = 'mp-child-container';

    this.items.forEach(item => {
      const child = document.createElement('div');
      child.className = 'mp-child' + ' ' + item.className;
...
//   wrapInitialItems() {
//     const initialChildContainer = document.createElement('div');
//     initialChildContainer.className = 'mp-initial-child-container';
